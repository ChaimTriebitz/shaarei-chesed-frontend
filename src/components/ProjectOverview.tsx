   ...
   return (
      <section className="project-overview">
         ...
         <div className="content">
            ...
            <p>
               As a buyer, your funds are fully protected: you will hold title
               to the land and make direct payments to the contractor during
            ...
            <p>
               This investment includes full customization options and
